<div style="background:#0d0d0d; min-height:100vh; font-family:'Orbitron', sans-serif; color:white; padding:40px; text-align:center;">
  ...
  <p style="font-size: 1.2rem; margin-top: 10px;">
    🚀 Data Science | Python Developer | AI Enthusiast
  </p>
  ...
  <!-- ⚙️ Tech Stack 3D Section -->
  <h2>🧰 Tech Stack – Floating in 3D</h2>

  <div align="center" style="margin-top: 20px;">
    <img src="https://skillicons.dev/icons?i=python,html,css,js,react,nodejs,mongodb,git,vscode,figma,sql" height="50" />
  </div>
